...
Single-user REST API (FastAPI) plus co-located MCP server exposing the same operations as native tools, sharing one auth model and one operation registry.
